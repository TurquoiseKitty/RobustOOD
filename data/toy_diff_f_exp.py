...
f_model_name_list = ["Lasso","KernelRidge-poly","KernelRidge-rbf","KernelRidge-linear","MLP"]
...
color_map = { -1: 'red', 1: 'blue', 0: 'yellow' }
...
fig.savefig("toy/diff_f.png")
fig.savefig("toy/diff_f.pdf")
